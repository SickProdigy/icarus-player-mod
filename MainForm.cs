...
internal sealed class MainForm : Form
{
    ...
    private Control BuildCreatureStatsPanel()
    {
        ...
        ConfigureButton(_applyGameStatsButton, "Default Game Stats");
        ...
        Label statsNote = new()
        {
            Text = "Game stats are generated by ICARUS from level, genetics, lineage, gear, and modifiers.\r\nThese values are shown/reset here, but are not currently reliably changeable.",
            Dock = DockStyle.Fill,
    ...
    private Control BuildCreatureGeneticsPanel()
    {
        ...
        TableLayoutPanel footer = new() { Dock = DockStyle.Fill, ColumnCount = 3, RowCount = 1 };
    ...
    private void ApplyGameDerivedStats()
    {
        ...
        _mountOxygenInput.Value = Math.Clamp(_selectedMount.OxygenLevel ?? 0, 0, decimal.ToInt32(_mountOxygenInput.Maximum));
        UpdateMountInfoLabel();
        SetStatus($"Applied game-derived stats for {_selectedMount.Name} at level {_selectedMount.Level}. Save to write Mounts.json.");
    }
