...
Appearance editing currently exposes the saved `Variation`, `UniqueVariation`, `CosmeticSkinIndex`, and `CosmeticSkinIndex_0` values. Phenotype support is still experimental because valid ranges and visual names vary by creature type.
